import { ControlParser, ObjectControlParser, StringControlParser, SelectionControlParser, ArrayControlParser, NumberControlParser, JsonFormElementMixin, JsonFormGroup, ValidationMixin, JsonFormParserMixin, JsonFormMixin, JsonMultiStepFormMixin, JsonFormElement, ExtendedStringControlParser, BooleanControlParser, DateControlParser, TimeControlParser, DateTimeControlParser, AsyncObjectControlParser, JsonForm } from '@aquarelle/json-form';
...
class RangeParser extends NumberControlParser
{
    getDefault(definition)
    {
...
var __vue_staticRenderFns__$6 = [];
  ...
  var RangeControl = __vue_normalize__$6(
...
var __vue_staticRenderFns__$7 = [];
  ...
  var CheckboxControl = __vue_normalize__$7(
...
/* template */
var __vue_render__$8 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('label',{directives:[{name:"show",rawName:"v-show",value:(_vm.text != null && _vm.text !== ''),expression:"text != null && text !== ''"}],staticClass:"v-label",class:{'error--text': _vm.hasError}},[_vm._v(_vm._s(_vm.text)),_c('sup',{directives:[{name:"show",rawName:"v-show",value:(_vm.required),expression:"required"}],staticStyle:{"user-select":"none"}},[_vm._v("*")])])};
var __vue_staticRenderFns__$8 = [];
  ...
  var ControlLabel = __vue_normalize__$8(
...
/* template */
var __vue_render__$9 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-icon',_vm._b({domProps:{"textContent":_vm._s(_vm.icon)}},'v-icon',_vm.$attrs,false))};
var __vue_staticRenderFns__$9 = [];
  ...
  var ControlIcon = __vue_normalize__$9(
...
var __vue_staticRenderFns__$a = [];
  ...
  var BlockError = __vue_normalize__$a(
...
/* template */
var __vue_render__$b = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.error !== null),expression:"error !== null"}],staticClass:"v-messages mt-1 error--text"},[_c('div',{staticClass:"v-messages__message"},[_vm._v("\n        "+_vm._s(_vm.error)+"\n    ")])])};
var __vue_staticRenderFns__$b = [];
  ...
  var ListError = __vue_normalize__$b(
...
var __vue_staticRenderFns__$c = [];
  ...
  var DialogForms = __vue_normalize__$c(
...
var __vue_staticRenderFns__$d = [];
  ...
  var BlockForm = __vue_normalize__$d(
...
/* template */
var __vue_render__$o = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-tabs',{attrs:{"right":_vm.display.position === 'right',"centered":_vm.display.position === 'center',"fixed-tabs":_vm.display.position === 'fixed',"icons-and-text":!!_vm.display.verticalIcons,"color":_vm.display.color || undefined,"dark":_vm.display.dark || undefined,"show-arrows":!!_vm.display.sliderArrows}},[_c('v-tabs-slider',{attrs:{"color":_vm.display.sliderColor || undefined}}),_vm._v(" "),_vm._l((_vm.items),function(item,key){return _c('v-tab',{key:_vm.$uniqueObjectId(item, key)},[(_vm.display.verticalIcons)?[_vm._v("\n            "+_vm._s(_vm.$intl.translate(item.title))+"\n        ")]:_vm._e(),_vm._v(" "),(_vm.tabHasError(item))?_c('v-icon',{attrs:{"color":"red"}},[_vm._v("error")]):(item.icon)?_c('v-icon',[_vm._v(_vm._s(_vm.$controlIcon(item.icon)))]):_vm._e(),_vm._v(" "),(!_vm.display.verticalIcons)?[_vm._v("\n            "+_vm._s(_vm.$intl.translate(item.title))+"\n        ")]:_vm._e()],2)}),_vm._v(" "),_c('v-tabs-items',{staticClass:"mt-1"},_vm._l((_vm.items),function(item,key){return _c('v-tab-item',{key:_vm.$uniqueObjectId(item, key),staticClass:"px-1"},[_c('json-form-group',{ref:"formGroup",refInFor:true,attrs:{"model":_vm.modelProxy,"validator":_vm.validatorProxy,"items":item.items,"name":item.name,"wrapper":_vm.wrapper,"path":_vm.path,"parent-validations-container":_vm.parentValidationsContainer,"validations-container":_vm.validationsContainer}})],1)}))],2)};
