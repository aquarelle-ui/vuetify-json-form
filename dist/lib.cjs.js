...
class TelParser extends jsonForm.StringControlParser
{
...
class EmailParser extends jsonForm.StringControlParser
{
    parse(definition, form, validator)
    {
        if (!definition.validation) {
...
class UrlParser extends jsonForm.StringControlParser
{
    parse(definition, form, validator)
    {
        if (!definition.validation) {
...
class GroupRepeatVariantsParser extends jsonForm.ControlParser
{
    ...
    getValidation(definition, form, data, validator)
    {
        ...
        data.config.regions.map(region => {
            ...
            jsonForm.ControlParser.setConfigUsingValidation(region.config, region.validation,
...
var script$b = {
    ...
    mixins: [jsonForm.ValidationMixin],
    props: {
        pushDelay: {
            type: Number,
            default: 100
...
var script$c = {
    name: 'block-form',
    components: {JsonFormGroup: jsonForm.JsonFormGroup, DialogForms},
...
var script$d = {
    name: 'stepper-form',
    components: {DialogForms, JsonFormGroup: jsonForm.JsonFormGroup},
    mixins: [jsonForm.ValidationMixin, jsonForm.JsonFormParserMixin, jsonForm.JsonFormOptionsMixin],
    props: {
        steps: {
            type: Array,
            required: true
...
var validators = {
    tel: new jsonForm.ValidatorItem("tel", p => p.value !== true ? null : v => {
        if (typeof v !== 'string') {
            return true;
        }
        if (v === '') {
    ...
    email: new jsonForm.ValidatorItem("email", p => p.value !== true ? null : v => {
        if (typeof v !== 'string') {
            return true;
        }
        if (v === '') {
    ...
    url: new jsonForm.ValidatorItem("url", p => p.value !== true ? null : v => {
        if (typeof v !== 'string') {
            return true;
        }
        if (v === '') {
